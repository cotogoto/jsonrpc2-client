...
public class JSONRPC2Session {
    ...
    private void storeCookies(final Map <String, List <String>> headers) {
        ...
        final var it = headers.entrySet().iterator();
        ...
        while (it.hasNext()) {
            ...
            final var it2 = h.getValue().iterator();

            while (it2.hasNext()) {

                final var cookieField = it2.next();
    ...
    public JSONRPC2Response send(final JSONRPC2Request request)
        ...
        try {
            final var wr = new OutputStreamWriter(con.getOutputStream());
        ...
        if (options.getAllowedResponseContentTypes() != null) {
            ...
            final var mimeType = rawResponse.getContentType();
