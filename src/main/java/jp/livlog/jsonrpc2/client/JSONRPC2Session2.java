 ...
 *
 * <p>The client-session class has a number of {@link JSONRPC2SessionOptions2
 ...
 * import jp.livlog.jsonrpc2.client.*;
 *
 * // The Base package for representing JSON-RPC 2.0 messages
 * import jp.livlog.jsonrpc2.*;
 *
...
public class JSONRPC2Session2 {
     ...
     */
    private JSONRPC2SessionOptions2       options;
     ...
     * specified URL. Uses a default {@link JSONRPC2SessionOptions2}
     * instance.
     *
     * @param url The server URL, e.g. "http://jsonrpc.example.com:8080".
     *            Must not be {@code null}.
     */
    public JSONRPC2Session2(final URL url) {
        ...
        options = new JSONRPC2SessionOptions2();
     ...
     */
    public JSONRPC2SessionOptions2 getOptions() {
     ...
     */
    public void setOptions(final JSONRPC2SessionOptions2 options) {
     ...
     * connection after the {@link JSONRPC2SessionOptions2 session options}
     ...
     *         {@link JSONRPC2SessionOptions2#acceptCookies accepted}.
     */
    ...
    private static void postString(final URLConnection con, final String data)
        ...
        try {
            final var wr = new OutputStreamWriter(con.getOutputStream(), "UTF-8");
            wr.write(data);
            wr.flush();
            wr.close();
     ...
     * any cookies {@link JSONRPC2SessionOptions2#acceptCookies()} if
     * required}.
     *
    ...
    private static void closeStreams(final URLConnection con) {
        ...
        try {
            final var httpCon = (HttpURLConnection) con;
    ...
    public JSONRPC2Response send(final JSONRPC2Request request)
        ...
        final var con = createURLConnection();
        ...
        final var contentType = rawResponse.getContentType();
        ...
        final var reqID = request.getID();
        final var resID = response.getID();
