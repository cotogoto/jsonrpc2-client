 ...
 * constructor specifies the default settings that the {@link JSONRPC2Session2}
 * uses. To apply different ones instantiate a new settings instance, set the
 * desired ones to your liking, and then {@link JSONRPC2Session2#setOptions pass}
 * it to your {@link JSONRPC2Session2} instance.
 *
 ...
 */
public class JSONRPC2SessionOptions2 {
     ...
     * {@link #trustAllCerts}.
     */
    public JSONRPC2SessionOptions2() {
